...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument("--init_weights", type=str, default="default", choices=['default', 'kaiming', 'xavier'])
        ...
        parser.add_argument("--seed", type=int, default=9076, help="random seed")
        ...
        parser.add_argument("--max_n", type=int, default=2)
        # training config
        ...
        parser.add_argument("--gamma_lr_drop", type=float, default=0.1, help="how much to drop at each lr_drop epochs")
        ...
        # Data config
        parser.add_argument("--max_q_l", type=int, default=500)
        parser.add_argument("--max_v_l", type=int, default=10000)
        ...
        parser.add_argument("--span_loss_type", default="l1", type=str, choices=['l1', 'ce', 'none'],
            ...
            if opt.is_eval:
                ...
                opt.results_dir = os.path.join(opt.results_root,
                                           "-".join([opt.dset_name, ctx_str, opt.exp_id,
                                                     time.strftime("%Y_%m_%d_%H_%M_%S"), random_str]))
